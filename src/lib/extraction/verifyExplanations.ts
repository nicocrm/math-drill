...
/**
 * Verifies that explanations are factual and non-hallucinated.
 * Strips explanations that fail verification.
 * On API failure, strips all explanations for safety.
 */

  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <textarea
        ...
        rows={4}
        className="min-h-[100px] rounded-xl border-2 border-zinc-200 bg-card px-4 py-2 text-foreground placeholder:text-muted-foreground focus:border-primary focus:outline-hidden focus:ring-2 focus:ring-primary/20 disabled:opacity-60 dark:border-zinc-600"
      />
      <button
        type="button"
        onClick={onConfirm}
